...
To empower students utilise their full potential spiritually, intellectually, physically, socially and morally.
     ...
     <div class="col-md-6 p-0 text-center order-1 order-sm-2">
        <img src="https://images.pexels.com/photos/2467506/pexels-photo-2467506.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="w-100" alt=""/>
     </div>
    ...
    <div class="col-md-6 p-4 p-sm-5">
      ...
      <p class="text-secondary" style="line-height: 2;">Maria Auxilium Girls’ Hr. Sec. School is situated at 15G Damalwar Street, Kancheepuram. It is set in a
