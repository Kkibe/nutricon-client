...
export default function Cookie() {
  ...
  return (
    <div className={`${isCookiesEnabled ? 'd-none' : 'd-flex'} align-items-center justify-content-evenly fixed-bottom w-100 p-1 bg-light`}>
      <small>This website uses cookies to improve user experience. By using our website you consent to all cookies in accordance with <a href="/about">our Cookie Policy.</a></small>
